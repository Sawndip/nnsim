...
$(BUILD_DIR)kernel_api.o:
	$(CC) -DUSE_CUDA -c -fPIC $(FLAGS) $(SRC_DIR)kernel_api.cpp -o $(BUILD_DIR)kernel_api.o
...
clean:
	rm $(BUILD_DIR)kernel_api.o $(BUILD_DIR)libkernel_api.so $(BUILD_DIR)py_neuronet.o nnsim_pykernel.so -r $(BUILD_DIR)

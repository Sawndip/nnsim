...
n_exc = create(4000, n_type="exc", Ie={'mean': 35., 'std': 10.})
n_inh = create(1000, n_type="inh")

con = connect(n_exc, n_inh+n_exc, conn_spec={'rule': 'fixed_total_num', 'N': 200000}, 
              weight={'mean': 6.0, 'std': 1.},
              delay={'mean': 30.0, 'std': 5.})

con2 = connect(n_inh, n_inh+n_exc, syn="inh", conn_spec={'rule': 'fixed_total_num', 'N': 50000}, 
              weight={'mean': 6.0, 'std': 1.},
              delay={'mean': 30.0, 'std': 5.})

neur_rec = n_exc[30:40]
